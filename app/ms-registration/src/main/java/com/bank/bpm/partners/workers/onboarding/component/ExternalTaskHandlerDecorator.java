...
public class ExternalTaskHandlerDecorator implements ExternalTaskHandler {
	...
	public static ExternalTaskHandlerDecorator from(final ExternalTaskHandler handler, final ExternalTaskSettings settings) {
		return new ExternalTaskHandlerDecorator(handler, settings);
	}
